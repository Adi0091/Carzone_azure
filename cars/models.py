...
class Car(models.Model):
    ...
    state = models.CharField(choices=state_choice, max_length=400)
    ...
    body_style = models.CharField(max_length=400)
    engine = models.CharField(max_length=400)
    transmission = models.CharField(max_length=400)
    kilometers = models.IntegerField()
    doors = models.CharField( choices=door_choices ,max_length=10)
    passengers = models.IntegerField()
    vin_no = models.CharField(max_length=400)
    mileage = models.IntegerField()
    fuel_type = models.CharField(max_length=50)
    no_of_oweners = models.CharField(max_length=400)
